<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="deleteemp.aspx.cs" Inherits="employeemanagement.deleteemp" %>
...
<body>
    ...
    <div>
        ...
        EmpID<br />
        <asp:Label ID="lbl_msg" runat="server" Text="Enter ID of Employee required to be deleted"></asp:Label>
        <br />
