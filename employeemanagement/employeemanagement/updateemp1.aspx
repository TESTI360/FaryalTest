<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="updateemp1.aspx.cs" Inherits="employeemanagement.updateemp1" %>
...
<body>
    ...
    <asp:Button ID="btupdateemp" runat="server"  Text="Update" Height="26px" OnClick="btnupdateemp_Click"  />
        </div>
    </form>
</body>
</html>
